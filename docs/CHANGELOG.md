...
All notable changes to FamilyHub will be documented in this file.
...
### Added
- Today widget for iOS home screen
- Push notifications for next class
- Period time display
- "What's on now" dashboard widget
...
**Maintained By:** Lawsons Enterprises Ltd
